...
$skin = $_GET["skin"];
$lowph=$con->prepare('select name_skin,ingredient,link_picture,cate_name from product 
left join category on product.id_category=category.id_category where id_skin='.$skin.'');
$lowph->execute();
